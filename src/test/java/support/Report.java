...
public class Report {
	...
	public static Report getInstance(){
		if(report==null){
			...
			testSummary.config().setDocumentTitle("JanIS - Report generated by Test Automation");
			testSummary.config().setReportName("JanIS - Report generated by Test Automation");
